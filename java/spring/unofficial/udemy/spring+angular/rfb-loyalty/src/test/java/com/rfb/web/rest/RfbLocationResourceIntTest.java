...
public class RfbLocationResourceIntTest {
    ...
    public static RfbLocation createEntity(EntityManager em) {
        RfbLocation rfbLocation = new RfbLocation()
            ...
            .runDayOfTheWeek(DEFAULT_RUN_DAY_OF_THE_WEEK);
        return rfbLocation;
    }
    ...
    public void createRfbLocation() throws Exception {
        ...
        assertThat(testRfbLocation.getRunDayOfTheWeek()).isEqualTo(DEFAULT_RUN_DAY_OF_THE_WEEK);
    }
    ...
    public void getRfbLocation() throws Exception {
        ...
        restRfbLocationMockMvc.perform(get("/api/rfb-locations/{id}", rfbLocation.getId()))
            ...
            .andExpect(jsonPath("$.runDayOfTheWeek").value(DEFAULT_RUN_DAY_OF_THE_WEEK.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateRfbLocation() throws Exception {
        ...
        updatedRfbLocation
            ...
            .runDayOfTheWeek(UPDATED_RUN_DAY_OF_THE_WEEK);
        ...
        assertThat(testRfbLocation.getRunDayOfTheWeek()).isEqualTo(UPDATED_RUN_DAY_OF_THE_WEEK);
    }
