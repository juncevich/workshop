...
/* harmony import */ var src_app_tasks_task_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/tasks/task.model */ "./src/app/tasks/task.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TasksAddComponent = /** @class */ (function () {
    ...
    TasksAddComponent.prototype.onTaskAdd = function (event) {
        var _this = this;
        var task = new src_app_tasks_task_model__WEBPACK_IMPORTED_MODULE_2__["Task"](event.target.value, false, this.getTodayAsString());
...
module.exports = __webpack_require__(/*! /home/juncevich/workshop/java/spring/unofficial/udemy/spring+angular/taskapp/src/main/frontend/src/main.ts */"./src/main.ts");
