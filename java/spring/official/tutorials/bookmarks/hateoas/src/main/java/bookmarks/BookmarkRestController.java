 ...
 */
@RestController @RequestMapping("/{userId}/bookmarks") class BookmarkRestController {
    ...
    @RequestMapping(method = RequestMethod.GET) Resources<BookmarkResource> readBookmarks(
    ...
    @RequestMapping(method = RequestMethod.POST) ResponseEntity<?> add(@PathVariable String userId,
