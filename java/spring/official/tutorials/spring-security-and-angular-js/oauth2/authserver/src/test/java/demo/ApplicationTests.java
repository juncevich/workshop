...
public class ApplicationTests {
    ...
    public void homePageProtected() {
        ...
        ResponseEntity<String> response =
                template.getForEntity("http://localhost:" + port + "/uaa/", String.class);
    ...
    public void userEndpointProtected() {
        ...
        ResponseEntity<String> response =
                template.getForEntity("http://localhost:" + port + "/uaa/user", String.class);
        assertEquals(HttpStatus.UNAUTHORIZED, response.getStatusCode());
        String auth = response.getHeaders().getFirst("WWW-Authenticate");
        assertTrue("Wrong header: " + auth, auth.startsWith("Bearer realm=\""));
    }
    ...
    public void authorizationRedirects() {
        ...
        ResponseEntity<String> response = template
                .getForEntity("http://localhost:" + port + "/uaa/oauth/authorize", String.class);
    ...
    public void loginSucceeds() {
        ...
        ResponseEntity<String> response =
                template.getForEntity("http://localhost:" + port + "/uaa/login", String.class);
    ...
    private String getCsrf(String soup) {
        ...
        Matcher matcher =
                Pattern.compile("(?s).*name=\"_csrf\".*?value=\"([^\"]+).*").matcher(soup);
        if (matcher.matches()) {
